...
@section('container')
    ...
    <div class="col-lg-8">
        <form action="/dashboard/categories/{{ $category->slug }}" method="POST" enctype="multipart/form-data" class="mb-5">
            @method('put')
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              @if ($category->image)
                <img src="{{ asset('storage/' . $category->image) }}" class="img-preview img-fluid mb-3 d-block col-sm-5" id="frame" style="max-height: 500px; overflow:hidden">
              @else
